...
/**
 * Created by tatsuya on 20/03/2018.
 */

public class FoodLoader extends BasicTask<Void, Food, List<Food>> {

    public FoodLoader(Context context, OnTaskCompleted<List<Food>> listener) {
