...
public class RiceLoader extends BasicTask<Void, Food, List<Food>> {
    public RiceLoader(Context context, OnTaskCompleted<List<Food>> listener) {
        super(context, listener);
        super.URL = super.HOST_NAME + "/ricews/ricews?WSDL";
        super.METHOD_NAME = "getAllRiceFood";
